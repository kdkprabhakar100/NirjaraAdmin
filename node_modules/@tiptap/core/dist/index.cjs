...
const liftListItem = (typeOrName) => ({ state, dispatch }) => {
	return (0, _tiptap_pm_schema_list.liftListItem)(getNodeType(typeOrName, state.schema))(state, dispatch);
};
//#endregion
...
const sinkListItem = (typeOrName) => ({ state, dispatch }) => {
	return (0, _tiptap_pm_schema_list.sinkListItem)(getNodeType(typeOrName, state.schema))(state, dispatch);
};
//#endregion
...
const wrapIn = (typeOrName, attributes = {}) => ({ state, dispatch }) => {
	return (0, _tiptap_pm_commands.wrapIn)(getNodeType(typeOrName, state.schema), attributes)(state, dispatch);
};
//#endregion
//#region src/commands/wrapInList.ts
const wrapInList = (typeOrName, attributes = {}) => ({ state, dispatch }) => {
	return (0, _tiptap_pm_schema_list.wrapInList)(getNodeType(typeOrName, state.schema), attributes)(state, dispatch);
};
//#endregion
...
//#endregion
//#region src/utilities/markdown/attributeUtils.ts
/**
...
function parseAttributes(attrString) {
	...
	Array.from(tempString.matchAll(/([a-zA-Z][\w-]*)\s*=\s*(__QUOTED_\d+__)/g)).forEach(([, key, quotedRef]) => {
		var _quotedRef$match;
		const quotedIndex = parseInt(((_quotedRef$match = quotedRef.match(/__QUOTED_(\d+)__/)) === null || _quotedRef$match === void 0 ? void 0 : _quotedRef$match[1]) || "0", 10);
...
* ```
*/
function renderNestedMarkdownContent(node, h, prefixOrGenerator, ctx) {
